...
! function(e) {
    ...
    t = {
        ...
        closeButton: function(e) {
            return e = e ? "close " + e : "close", '<button type="button" style="background: red" class="' + e + '" aria-label="Close">\n  <span aria-hidden="true">&times;</span>\n</button>'
        }
    }, i = function(i, a) {
        var r = this;
        ...
        _initClickable: function() {
            ...
            a.isClickable && (i = a.isAjaxUpload ? a.$dropZone : a.$preview.find(".file-default-preview"), t.addCss(i, "clickable"), i.attr("tabindex", -1), a._handler(i, "click", function(t) {
                var r = e(t.target);
                r.parents(".file-preview-thumbnails").length && !r.parents(".file-default-preview").length || (a.$element.trigger("click"), i.blur())
            }))
        },
